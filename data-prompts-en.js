...
const promptData = {
  ...
  openclaw: {
    ...
    categories: [
      { name: 'Core Slash Commands', shortcuts: [
        { keys: '/new [model]', desc: 'Archive the current session and start a fresh one', usage: 'Type in any connected chat channel or the Control UI.' },
        ...
        { keys: '/stop', desc: 'Abort the current run', usage: 'Type in any connected chat channel or the Control UI.' },
        { keys: '/session idle <duration|off>', desc: 'Manage thread-binding idle expiry', usage: 'Type in any connected chat channel or the Control UI.' },
        { keys: '/session max-age <duration|off>', desc: 'Manage thread-binding max-age expiry', usage: 'Type in any connected chat channel or the Control UI.' },
        ...
        { keys: '/trace on|off', desc: 'Toggle plugin trace output for the current session', usage: 'Type in any connected chat channel or the Control UI.' },
        ...
        { keys: '/help', desc: 'Show the short help summary', usage: 'Type in any connected chat channel or the Control UI.' },
        { keys: '/commands', desc: 'Show the generated command catalog', usage: 'Type in any connected chat channel or the Control UI.' },
        { keys: '/tools [compact|verbose]', desc: 'Show what the current agent can use right now', usage: 'Type in any connected chat channel or the Control UI.' },
        { keys: '/status', desc: 'Show execution/runtime status, Gateway and system uptime, plugin health, plus provider usage/quota', usage: 'Type in any connected chat channel or the Control UI.' },
        ...
        { keys: '/openclaw <request>', desc: 'Run the OpenClaw setup and repair helper from an owner DM', usage: 'Type in any connected chat channel or the Control UI.' },
        { keys: '/tasks', desc: 'List active/recent background tasks for the current session', usage: 'Type in any connected chat channel or the Control UI.' },
        { keys: '/context [list|detail|map|json]', desc: 'Explain how context is assembled', usage: 'Type in any connected chat channel or the Control UI.' },
        { keys: '/whoami', desc: 'Show your sender id', usage: 'Alias: /id' },
        { keys: '/usage off|tokens|full|reset|cost', desc: 'Control the per-response usage footer (reset/inherit/clear/default clears the session override to re-inherit the...', usage: 'Type in any connected chat channel or the Control UI.' },
        { keys: '/skill <name> [input]', desc: 'Run a skill by name', usage: 'Type in any connected chat channel or the Control UI.' },
        { keys: '/learn [request]', desc: 'Draft one reviewable skill from the current conversation or named sources through Skill Workshop', usage: 'Type in any connected chat channel or the Control UI.' },
        ...
        { keys: '/approve <id> <decision>', desc: 'Resolve exec or plugin approval prompts', usage: 'Type in any connected chat channel or the Control UI.' },
        { keys: '/btw <question>', desc: 'Ask a side question without changing session context', usage: 'Alias: /side. See BTW' },
        { keys: '/subagents list|log|info', desc: 'Inspect sub-agent runs for the current session', usage: 'Type in any connected chat channel or the Control UI.' },
        { keys: '/focus <target>', desc: 'Bind the current Discord thread or Telegram topic to a session target', usage: 'Type in any connected chat channel or the Control UI.' },
        { keys: '/unfocus', desc: 'Remove the current thread binding', usage: 'Type in any connected chat channel or the Control UI.' },
        { keys: '/agents', desc: 'List thread-bound agents for the current session', usage: 'Type in any connected chat channel or the Control UI.' },
        { keys: '/config show|get|set|unset', desc: 'commands.config: true | Read or write openclaw.json', usage: 'Owner-only' },
        { keys: '/mcp show|get|set|unset', desc: 'commands.mcp: true | Read or write OpenClaw-managed MCP server config', usage: 'Owner-only' },
        { keys: '/debug show|set|unset|reset', desc: 'commands.debug: true | Runtime-only config overrides', usage: 'Owner-only' },
        { keys: '/restart', desc: 'commands.restart: true (default) | Restart OpenClaw', usage: 'Type in any connected chat channel or the Control UI.' },
        { keys: '/send on|off|inherit', desc: 'owner | Set send policy', usage: 'Type in any connected chat channel or the Control UI.' },
        { keys: '/activation mention|always', desc: 'Set group activation mode', usage: 'Type in any connected chat channel or the Control UI.' },
        { keys: '/bash <command>', desc: 'Run a host shell command', usage: 'Alias: ! <command>. Requires commands.bash: true' }
      ] },
      { name: 'Subcommand Families', shortcuts: [
        { keys: '/tools ...', desc: 'What the agent can use now', usage: 'Results are session-scoped. Changing agent, channel, thread, sender' },
        { keys: '/loop ...', desc: 'Recurring conversation work', usage: 'Subcommand family; run without arguments to see current state.' },
        { keys: '/model ...', desc: 'Model selection', usage: 'Direct owner/admin `/model <model>` requests **default scope**: it changes this session and starts a best-effort configured-default update. Adding `-s` uses **session scope**: only this sess' },
        { keys: '/config ...', desc: 'On-disk config writes', usage: 'Config is validated before write. Invalid changes are rejected. `/config`' },
        { keys: '/mcp ...', desc: 'MCP server config', usage: 'Subcommand family; run without arguments to see current state.' },
        { keys: '/debug ...', desc: 'Runtime-only overrides', usage: 'Subcommand family; run without arguments to see current state.' },
        { keys: '/plugins ...', desc: 'Plugin management', usage: 'Gateways automatically because plugin source modules changed. Trusted ClawHub' },
        { keys: '/trace ...', desc: 'Plugin trace output', usage: 'Subcommand family; run without arguments to see current state.' },
        { keys: '/btw ...', desc: 'Side questions', usage: 'In the Control UI, `/btw` and `/side` open the session rail and ask its' }
      ] },
      { name: 'openclaw CLI', shortcuts: [
        { keys: 'openclaw setup', desc: 'And `openclaw onboard` verify inference first, then start OpenClaw for Gateway, workspace, channels, skills, and...', usage: 'Run in a terminal on the Gateway host.' },
        { keys: 'openclaw setup --baseline', desc: 'Creates the baseline config and workspace without walking the guided onboarding flow', usage: 'Run in a terminal on the Gateway host.' },
        { keys: 'openclaw configure', desc: 'Changes targeted parts of an existing setup: model auth, gateway, channels, plugins, or skills', usage: 'Run in a terminal on the Gateway host.' },
        { keys: 'openclaw channels add', desc: 'Configures channel accounts after the baseline exists; a channel selection alone uses guided setup, while account,...', usage: 'Run in a terminal on the Gateway host.' },
        { keys: 'openclaw status --usage', desc: 'Show Gateway status including usage', usage: 'Run in a terminal on the Gateway host.' },
        { keys: 'openclaw update', desc: 'Update OpenClaw to the latest release', usage: 'Run in a terminal on the Gateway host.' }
      ] }
    ]
  },
  nous_hermes: {
    name: 'Nous Hermes',
    icon: 'fas fa-scroll',
    source: { name: 'Hermes 4 model card & Hermes Agent docs', url: 'https://huggingface.co/NousResearch/Hermes-4-405B' },
    categories: [
      { name: 'Hermes 4 Prompt Format & Tool Calling', shortcuts: [
        { keys: '<|start_header_id|>role<|end_header_id|>', desc: 'Llama 3.1 chat header tokens used by Hermes 4 405B', usage: 'Roles: system, user, assistant. Each turn ends with <|eot_id|>. Smaller Hermes 4 models use ChatML instead.' },
        { keys: '<|eot_id|>', desc: 'End-of-turn token in the 405B prompt format', usage: 'Closes each header-delimited message.' },
        { keys: 'thinking=True', desc: 'Chat template flag that activates reasoning mode', usage: 'Pass to the tokenizer chat template; alternatively use the deep-thinking system prompt from the model card.' },
        { keys: '<think> </think>', desc: 'Tags enclosing the model\'s internal reasoning', usage: 'Emitted when reasoning mode is active; strip them to get the final answer only.' },
        { keys: 'You are a deep thinking AI...', desc: 'Official reasoning-mode system prompt', usage: 'Full text on the model card. Additional system instructions before or after it adjust thinking effort, style, and format.' },
        { keys: '<tools> </tools>', desc: 'System-prompt tags wrapping the JSON tool signatures', usage: 'Function definitions go inside these tags in the system message.' },
        { keys: '<tool_call> </tool_call>', desc: 'Tags the model emits around a JSON function call', usage: 'Parse the JSON inside to execute the call.' },
        { keys: '<tool_response> </tool_response>', desc: 'Tags wrapping the tool result you feed back', usage: 'Return the function output inside these tags in a tool role message.' }
      ] },
      { name: 'Hermes Agent Slash Commands', shortcuts: [
        { keys: '/new [name]', desc: 'Start a new session (fresh session ID + history)', usage: 'Alias: /reset. Optional [name] sets the initial session title — e.g.' },
        { keys: '/clear', desc: 'Clear screen and start a new session', usage: 'Type in the Hermes CLI/TUI or a connected messaging channel.' },
        { keys: '/history', desc: 'Show conversation history (respects', usage: 'Type in the Hermes CLI/TUI or a connected messaging channel.' },
        { keys: '/save', desc: 'Save the current conversation', usage: 'Type in the Hermes CLI/TUI or a connected messaging channel.' },
        { keys: '/prompt', desc: 'Compose your next prompt in $EDITOR (markdown) instead of the inline input — useful for long, multi-line, or...', usage: 'Alias: /compose.' },
        { keys: '/retry', desc: 'Retry the last message (resend to agent)', usage: 'Type in the Hermes CLI/TUI or a connected messaging channel.' },
        { keys: '/undo', desc: 'Remove the last user/assistant exchange', usage: 'Type in the Hermes CLI/TUI or a connected messaging channel.' },
        { keys: '/title', desc: 'Set a title for the current session (usage: /title My Session Name)', usage: 'Type in the Hermes CLI/TUI or a connected messaging channel.' },
        { keys: '/rollback', desc: 'List or restore filesystem checkpoints (usage: /rollback [number])', usage: 'Type in the Hermes CLI/TUI or a connected messaging channel.' },
        { keys: '/diff [staged|all|session] [--stat] [path...]', desc: 'Show git changes in the working directory', usage: 'Default: unstaged changes plus untracked files. staged shows what\'s staged for commit,' },
        { keys: '/snapshot [create|restore <id>|prune]', desc: 'Create or restore state snapshots of Hermes config/state', usage: 'Alias: /snap. create [label] saves a snapshot,' },
        { keys: '/stop', desc: 'Kill all running background processes', usage: 'Type in the Hermes CLI/TUI or a connected messaging channel.' },
        { keys: '/steer <prompt>', desc: 'Inject a mid-run note that arrives at the agent after the next tool call — no interrupt, no new user turn', usage: 'The text is appended to the last tool result\'s content once the current tool completes, giving the agent new context without breaking the current tool-calling loop. Use this to nudge...' },
        { keys: '/goal <text>', desc: 'Set a standing goal Hermes works toward across turns — our take on the Ralph loop', usage: 'After each turn an auxiliary judge model decides whether the goal is done; if not, Hermes auto-continues. Subcommands:' },
        { keys: '/subgoal <text>', desc: 'Append a user-supplied criterion to the active goal mid-loop', usage: 'The continuation prompt surfaces all subgoals to the agent verbatim, and the judge factors them into its DONE/CONTINUE verdict — so the goal isn\'t marked done until the original goal and...' },
        { keys: '/heartbeat every <interval> <prompt>', desc: 'Set a recurring prompt that re-enters this session as a normal user turn whenever it\'s idle and the interval has...', usage: 'Alias: /hb. Subcommands:' },
        { keys: '/refine [focus]', desc: 'Run the background memory/skill self-improvement review now instead of waiting for the automatic post-turn trigger', usage: 'Optional focus text steers the review (e.g.' },
        ...
        { keys: '/switch', desc: 'Classic CLI: browse and resume previous sessions in an interactive picker', usage: 'TUI: open the live session switcher for currently open TUI sessions. Use' },
        { keys: '/egress [status]', desc: 'Show Docker egress proxy status — enabled/configured/running state, credential source, token mappings, uncovered...', usage: 'Works in CLI, TUI, Desktop chat, and messaging gateway.' },
        { keys: '/redraw', desc: 'Force a full UI repaint (recovers from terminal drift after tmux resize, mouse selection artifacts, etc.)', usage: 'Type in the Hermes CLI/TUI or a connected messaging channel.' },
        { keys: '/status', desc: 'Show session info — model, provider, profile, session ID, working directory, title, created/updated timestamps,...', usage: 'Type in the Hermes CLI/TUI or a connected messaging channel.' },
        { keys: '/context [all]', desc: 'Visual context-window breakdown', usage: 'Alias: /ctx. On the CLI/TUI: a 5×20 glyph block grid (each cell ≈ 1% of the model window) plus an estimated per-category table — system prompt, tool definitions, rules, skills index, MCP, subagen' },
        { keys: '/agents', desc: 'Show active agents and running tasks across the current session', usage: 'Alias: /tasks.' },
        { keys: '/btw', desc: 'Run a prompt in a separate background session', usage: 'The agent processes your prompt independently — your current session stays free for other work. Results appear as a panel when the task finishes. See CLI Background Sessions .' },
        { keys: '/branch [name]', desc: 'Branch the current session (explore a different path)', usage: 'Alias: /fork.' },
        { keys: '/worktree [new [name]|list]', desc: 'CLI only', usage: 'Inspect or create isolated git worktrees mid-session (inspired by Copilot CLI\'s' },
        { keys: '/handoff <platform>', desc: 'CLI only', usage: 'Hand the current session off to a messaging platform (Telegram, Discord, Slack, WhatsApp, Signal, Matrix). The gateway picks it up immediately, creates a fresh thread on platforms that...' },
        { keys: '/memory-graph', desc: 'Open the learning journey timeline of learned skills + memories', usage: 'Works in the classic CLI, as a TUI overlay, and in the desktop app (Star Map panel). Not available on messaging platforms. See Learning Journey .' },
        { keys: '/config', desc: 'Show current configuration', usage: 'Type in the Hermes CLI/TUI or a connected messaging channel.' },
        { keys: '/model [model-name]', desc: 'Show or change the current model', usage: 'Supports:' },
        { keys: '/codex-runtime [auto|codex_app_server|on|off]', desc: 'Toggle the optional Codex app-server runtime for OpenAI/Codex models', usage: 'Type in the Hermes CLI/TUI or a connected messaging channel.' },
        { keys: '/personality', desc: 'Set a predefined personality', usage: 'Type in the Hermes CLI/TUI or a connected messaging channel.' },
