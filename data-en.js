    ...
    categories: [
      {
        name: 'Editing',
        shortcuts: [
          { keys: 'Shift + Shift', desc: 'Search everywhere', usage: 'Search files, classes, actions.' },
          { keys: 'Ctrl + Shift + A', desc: 'Find action', usage: 'Search IDE actions.' },
          { keys: 'Ctrl + B', desc: 'Go to definition', usage: 'Navigate to symbol definition.' },
          { keys: 'Alt + Enter', desc: 'Quick fix', usage: 'Show context-aware fixes.' },
          { keys: 'Ctrl + /', desc: 'Toggle comment', usage: 'Toggle line comment.' },
          { keys: 'Ctrl + D', desc: 'Duplicate line', usage: 'Duplicate current line.' },
          { keys: 'Ctrl + Shift + F', desc: 'Find in path', usage: 'Search across the project.' },
          { keys: 'Alt + F7', desc: 'Find usages', usage: 'Find all usages of a symbol.' },
        ]
      },
    ]
  },
    ...
    categories: [
      {
        ...
        shortcuts: [
          ...
          { keys: 'Ctrl + B', desc: 'Go to definition', usage: 'Navigate to definition.' },
          { keys: 'Ctrl + Shift + R', desc: 'Refactor', usage: 'Open refactoring menu.' },
    ...
    categories: [
      {
        name: 'Editing',
        shortcuts: [
          { keys: 'i', desc: 'Insert mode', usage: 'Enter insert mode.' },
          { keys: 'Esc', desc: 'Normal mode', usage: 'Return to normal mode.' },
          { keys: 'Space + f', desc: 'File picker', usage: 'Open file picker.' },
          { keys: 'Space + b', desc: 'Buffer picker', usage: 'Open buffer picker.' },
          { keys: 'd', desc: 'Delete', usage: 'Delete selection.' },
          { keys: 'y', desc: 'Yank', usage: 'Copy selection.' },
          { keys: 'p', desc: 'Paste', usage: 'Paste clipboard.' },
          { keys: 'u', desc: 'Undo', usage: 'Undo last action.' },
        ]
      },
    ]
    ...
    categories: [
      {
        name: 'Editing',
        shortcuts: [
          { keys: 'Ctrl + O', desc: 'Save', usage: 'Save the file.' },
          { keys: 'Ctrl + X', desc: 'Exit', usage: 'Exit Nano.' },
          { keys: 'Ctrl + K', desc: 'Cut line', usage: 'Cut the current line.' },
          { keys: 'Ctrl + U', desc: 'Paste', usage: 'Paste cut text.' },
          { keys: 'Ctrl + W', desc: 'Search', usage: 'Search for text.' },
          { keys: 'Ctrl + \\\\', desc: 'Find & Replace', usage: 'Find and replace text.' },
          { keys: 'Ctrl + G', desc: 'Help', usage: 'Show help.' },
          { keys: 'Alt + U', desc: 'Undo', usage: 'Undo last action.' },
        ]
      },
    ]
  },
