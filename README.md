...
The open dataset behind [shortcut-tools.com](https://shortcut-tools.com) — **12,900+ keyboard shortcuts across 270 platforms** (VS Code, Vim, tmux, Figma, Slack, kubectl and more).
