...
The open dataset behind [shortcut-tools.com](https://shortcut-tools.com) — **13,572 keyboard shortcuts across 268 platforms** (VS Code, Vim, tmux, Figma, Slack, kubectl and more).
