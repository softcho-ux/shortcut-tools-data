...
The open dataset behind [shortcut-tools.com](https://shortcut-tools.com) — **5,900+ keyboard shortcuts across 271 platforms** (VS Code, Vim, tmux, Figma, Slack, kubectl and more).
